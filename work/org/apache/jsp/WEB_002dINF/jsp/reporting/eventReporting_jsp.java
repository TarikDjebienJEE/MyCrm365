...
public final class eventReporting_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	Map<String, Integer> repartitionData = (Map<String, Integer>) request.getAttribute("repartitionData");
      ...
      out.write("\t<ul>\n");
      out.write("\t\t<li><a href=\"#dayReport\">Event evolution</a></li>\n");
      out.write("\t\t<li><a href=\"#repartitionReport\">Event repartition</a></li>\n");
      out.write("\t</ul>\n");
      out.write("<section>\n");
      out.write("\n");
      ...
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t},\n");
      out.write("\t\t\t\ttitle: 'Number of events integrated by day',\n");
      ...
      out.write("\t});\n");
      out.write("  \n");
      out.write("  \tif (repartitionData[0].length > 0) {\n");
      out.write("  \n");
      out.write("  \t\t$.jqplot (\n");
      out.write("  \t\t\t'repartitionReport', \n");
      out.write("  \t\t\trepartitionData, \n");
      out.write("\t    \t{ \n");
      out.write("\t      \ttitle: 'Event type repartition - all time',\n");
      out.write("\t      \tseriesDefaults: {\n");
